...
import com.ics.ics_hc_offline.sintomasfragment.ReferenciaSintomasFragment;

public class ReferenciaSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ReferenciaSintomasFragment fragment = new ReferenciaSintomasFragment();
