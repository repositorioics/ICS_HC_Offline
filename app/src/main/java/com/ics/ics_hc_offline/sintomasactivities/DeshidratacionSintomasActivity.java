...
import com.ics.ics_hc_offline.sintomasfragment.DeshidratacionSintomasFragment;

public class DeshidratacionSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            DeshidratacionSintomasFragment fragment = new DeshidratacionSintomasFragment();
