...
import com.ics.ics_hc_offline.sintomasfragment.RenalSintomasFragment;

public class RenalSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            RenalSintomasFragment fragment = new RenalSintomasFragment();
