...
import com.ics.ics_hc_offline.sintomasfragment.OsteomuscularSintomasFragment;

public class OsteomuscularSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            OsteomuscularSintomasFragment fragment = new OsteomuscularSintomasFragment();
