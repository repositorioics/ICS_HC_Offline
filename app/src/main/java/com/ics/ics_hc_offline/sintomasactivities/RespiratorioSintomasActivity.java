...
import com.ics.ics_hc_offline.sintomasfragment.RespiratorioSintomasFragment;

public class RespiratorioSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            RespiratorioSintomasFragment fragment = new RespiratorioSintomasFragment();
