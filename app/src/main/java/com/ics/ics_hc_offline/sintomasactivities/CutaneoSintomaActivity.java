...
import com.ics.ics_hc_offline.sintomasfragment.CutaneoSintomaFragment;

public class CutaneoSintomaActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            CutaneoSintomaFragment fragment = new CutaneoSintomaFragment();
