...
import com.ics.ics_hc_offline.sintomasfragment.VacunasSintomasFragment;

public class VacunasSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            VacunasSintomasFragment fragment = new VacunasSintomasFragment();
