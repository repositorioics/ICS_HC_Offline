...
import com.ics.ics_hc_offline.sintomasfragment.GastrointestinalSintomasFragment;

public class GastrointestinalSintomasActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            GastrointestinalSintomasFragment fragment = new GastrointestinalSintomasFragment();
