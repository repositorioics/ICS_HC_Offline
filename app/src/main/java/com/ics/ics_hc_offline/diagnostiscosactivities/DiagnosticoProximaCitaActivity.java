...
import com.ics.ics_hc_offline.diagnostiscosfragment.DiagnosticoProximaCitaFragment;

public class DiagnosticoProximaCitaActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            DiagnosticoProximaCitaFragment fragment = new DiagnosticoProximaCitaFragment();
